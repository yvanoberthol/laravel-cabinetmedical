...
class MedecinUpdateRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            /*'photo.required' => 'Svp vous devez fournir une photo pour cet article',
            'photo.image' => 'Svp insérer une image',
            'photo.mimes' => 'Entrez une image valide(jpeg,png,jpg,bmp) pour cet article',
            'photo.max' => 'L\'image ne doit pas excéder 2Mo'*/
        ];
    }
}
